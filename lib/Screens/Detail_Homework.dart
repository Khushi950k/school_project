...
class DetailHomework extends StatefulWidget {
  const DetailHomework({Key? key}) : super(key: key);

  @override
  State<DetailHomework> createState() => _DetailHomeworkState();
}

class _DetailHomeworkState extends State<DetailHomework> {
  bool onClick = false;
  bool Click = false;
  bool Click1 = false;
  bool Click2 = false;
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text("Detail Homework",style:TextStyle(fontSize: 15, fontWeight: FontWeight.w600, color: Colors.black) ,),
            ),
            SizedBox(height: 10,),
            Center(
              child: Column(
